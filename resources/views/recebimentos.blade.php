...
<body>
    <div class="container pt-">
        ...
        <h4 class="mb-4">Adicionar Recebimento</h4>

        <form action="/recebimento" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="form-group d-flex flex-row">
                <label for="cliente" style="width: 70pt">Cliente :</label>
                <input type="text" name="cliente" class="form-control input d-inline-flex">
            </div>
        ...
        <h4 class="text-center mt-4">Histórico de Recebimentos</h4>
        <table class="table table-striped mt-2">
            ...
            <tbody>
                @foreach ($recebimentos as $recebimento)
                    @if ($recebimento->usuario_id == $id_user)
                        <?php 
